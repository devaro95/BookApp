...
import com.data.repository.ApiBookAppRepository
import com.data.repository.BookAppSessionRepository
import com.data.repository.CacheApiLdaRepository
...
fun generateDataModule() = Kodein.Module(name = "DataModule") {
    ...
    bind<BookAppRepository>() with singleton {
        CacheApiLdaRepository(
                ApiBookAppRepository(instance(), instance(), instance(), instance())
        )
    }
